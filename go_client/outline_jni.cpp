...
// Замени com/example/yourapp/Native на свой package/class
extern "C" JNIEXPORT void JNICALL
Java_com_example_yourapp_Native_newOutlineDevice(JNIEnv* env, jclass /*clazz*/, jstring jConfig) {
...
Java_com_example_yourapp_Native_write(JNIEnv* env, jclass /*clazz*/, jbyteArray jBuf, jint length) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_example_yourapp_Native_read(JNIEnv* env, jclass /*clazz*/, jbyteArray jBuf, jint maxLen) {
