...
const (
	...
	Vpn_AddTapDevice_FullMethodName        = "/grpcproto.Vpn/AddTapDevice"
)
...
type VpnClient interface {
	...
	// drivers.go
	AddTapDevice(ctx context.Context, in *AddTapDeviceRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *vpnClient) AddTapDevice(ctx context.Context, in *AddTapDeviceRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Vpn_AddTapDevice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VpnServer interface {
	...
	// drivers.go
	AddTapDevice(context.Context, *AddTapDeviceRequest) (*Empty, error)
...
func (UnimplementedVpnServer) StartAwg(context.Context, *StartAwgRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method StartAwg not implemented")
}
func (UnimplementedVpnServer) StopAwg(context.Context, *Empty) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method StopAwg not implemented")
}
...
func (UnimplementedVpnServer) CheckServerAlive(context.Context, *CheckServerAliveRequest) (*CheckServerAliveResponce, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckServerAlive not implemented")
}
...
func (UnimplementedVpnServer) AddTapDevice(context.Context, *AddTapDeviceRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AddTapDevice not implemented")
}
...
func _Vpn_AddTapDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddTapDeviceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VpnServer).AddTapDevice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Vpn_AddTapDevice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VpnServer).AddTapDevice(ctx, req.(*AddTapDeviceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Vpn_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddTapDevice",
			Handler:    _Vpn_AddTapDevice_Handler,
		},
	},
