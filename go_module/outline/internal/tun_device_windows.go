...
func NewTunDevice(name, ip string) (network.IPDevice, error) {
	...
	log.SimpleDebugf(Category, "[Wintun] Creating adapter...")
	...
	log.SimpleDebugf(Category, "[Wintun] Adapter created: %s", name)
...
func (d *wintunDevice) configureIP(ip string) error {
	log.SimpleDebugf(Category, "[Wintun] Configuring IP: %s", ip)
