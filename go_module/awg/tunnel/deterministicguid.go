...
const deterministicGUIDLabel = "Deterministic DobbyVPN Windows GUID v1 https://github.com/DobbyVPN/DobbyVPN"
const fixedGUIDLabel = "Fixed DobbyVPN Windows GUID v1 https://github.com/DobbyVPN/DobbyVPN"
...
func deterministicGUID(c *config.Config) *windows.GUID {
