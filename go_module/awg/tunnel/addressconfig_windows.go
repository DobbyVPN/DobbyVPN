...
func configureInterface(family winipcfg.AddressFamily, conf *config.Config, tun *tun.NativeTun) error {
...
func enableFirewall(conf *config.Config, tun *tun.NativeTun) error {
	doNotRestrict := true
