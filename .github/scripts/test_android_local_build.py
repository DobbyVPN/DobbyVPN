...
case "${1:-}" in
  ...
  list)
    case "$*" in
      ...
      *fyne.io/fyne/v2*) printf 'fyne.io/fyne/v2\tv2.8.1\tgithub.com/DobbyVPN/fyne/v2\tv2.0.0-20260921092014-0987cd6d54b1\n' ;;
...
case "$*" in
  ...
  *android_dependency_provenance.py*--print-go-ui-replacements*)
    printf 'fyne.io/fyne/v2\\tv2.8.1\\tgithub.com/DobbyVPN/fyne/v2\\tv2.0.0-20260921092014-0987cd6d54b1\\t0987cd6d54b10d2fde5ab069131f1515bf30c906\\n'
